...
class sonicSensor:
    ...
    def __init__(self, myLocation, arduinoPin, uniqueID, actuatorServo):
        '''
        myLocation - string identifier for where the sensor is located
        arduinoPin - arduino pin for this sensor
        ...
        self.arduinoPin = int(arduinoPin)
    ...
    def rotateToNext(self):
        ...
        self.actuator.rotate(currentRotation * 90)

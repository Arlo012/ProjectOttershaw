...
class SpiderLeg:
	...
	def GetAngles(self):
		...
		#Calculations for theta1, hip
		theta1 = 180/math.pi*math.acos(y/G)
		if z > 0:		#Z is BELOW the zero level
			...
			numerator3 = SpiderLeg.L_Thigh**2 + SpiderLeg.L_Calf**2 - H**2
			denominator3 = 2 * SpiderLeg.L_Thigh * SpiderLeg.L_Calf
			theta3 = 180 - 180/math.pi * math.acos(numerator3/denominator3)
		
		else:
			#Calculations for theta2, shoulder
			numerator2 = -SpiderLeg.L_Calf**2 + SpiderLeg.L_Thigh**2 + H**2
			denominator2 = 2 * SpiderLeg.L_Thigh * H
			theta2 = 90 - 180/math.pi * math.asin(abs(z)/H) - 180/math.pi * math.acos(numerator2/denominator2)
